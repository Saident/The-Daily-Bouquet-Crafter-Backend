...
func GetDailyInventory(hasSpecialUnlock bool) []string {
	...
	now := time.Now().In(loc)
	// Using UTC ensures it changes at the same moment everywhere, 
	// but you can change this to a specific timezone if you want it to reset at her local midnight.
